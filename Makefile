...
$(bDir)jelly_lexer.o: $(srcDir)jelly_lexer.cpp $(srcDir)jelly_lexer.h $(srcDir)tokens.h $(srcDir)positional_types.h
...
$(bDir)branch.o: $(srcDir)branch.cpp $(srcDir)branch.h $(srcDir)positional_types.h
